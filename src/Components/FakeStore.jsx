...
import {filterProduct, products} from '../features/actions/products'
  ...
  const search = () => {
    category && dispatch(filterProduct(category))
  }
          ...
          <div className="sm:flex-auto justify-center items-center text-center">
            ...
            <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none flex justify-center gap-6">
              <form className="mr-20">
                <select className="p-4 rounded-md" onChange={changeCategory}>
